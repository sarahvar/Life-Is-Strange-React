...
export const MemoryGameProvider = ({ children }) => {
  ...
  const easyImages = [
    ...
    { id: 13, src: '/assets/William-Price.png' }
  ];
  ...
  const mediumImages = [
    ...
    { id: 11, src: '/assets/Rayan-Caufield.png' },
  ];
  ...
  const hardImages = [
    ...
    { id: 13, src: '/assets/William-Price.png' },
    { id: 14, src: '/assets/Mark_jefferson.webp' },
    { id: 15, src: '/assets/Max-Biche.webp' },
    { id: 16, src: '/assets/Home.jpg'},
  ];
