...
const initialQuestions = [
  { question: 'Quel est le nom complet de Max ?', answers: ['Maxine Caulfield', 'Max Caulfield', 'Maxine Carter', 'Max Carter'], correct: 0 },
  { question: 'Quel est le super pouvoir de Max ?', answers: ['Télékinésie', 'Voyage dans le temps', 'Télépathie', 'Invisibilité'], correct: 1 },
  { question: 'Quel est le nom de l\'amie d\'enfance de Max ?', answers: ['Rachel Amber', 'Victoria Chase', 'Kate Marsh', 'Chloé Price'], correct: 3 },
  { question: 'Quel est le nom de l\'école que Max fréquente ?', answers: ['Arcadia Bay School', 'Pacific Northwest School', 'Blackwell Academy', 'West Coast Academy'], correct: 2 },
  { question: 'Comment s\'appelle la ville où se déroule l\'histoire ?', answers: ['Arcadia Bay', 'Bright Falls', 'Twin Peaks', 'Silent Hill'], correct: 0 },
  { question: 'Quelle est la passion artistique de Max ?', answers: ['Peinture', 'Photographie', 'Écriture', 'Musique'], correct: 1 },
  { question: 'Quelle est la principale cause des conflits entre Max et Chloé ?', answers: ['Le déménagement de Max', 'Les secrets de Chloé', 'La disparition de Rachel', 'Les relations amoureuses'], correct: 0 },
  { question: 'Pourquoi Max retourne-t-elle à Arcadia Bay après plusieurs années d\'absence ?', answers: ['Pour renouer avec sa meilleure amie Chloé', 'Pour un projet de photographie', 'Pour suivre des cours à la Blackwell Academy', 'Pour résoudre un mystère local'], correct: 2 },
  { question: 'Quel est le nom de la mère de Max ?', answers: ['Joyce', 'Diana', 'Sarah', 'Vanessa'], correct: 3 },
  { question: 'Qui est le beau-père de Chloé ?', answers: ['Proviseur Wells', 'Mark Jefferson', 'David Madsen', 'Sean Prescott'], correct: 2 }
];
...
const QuizPage = () => {
  ...
  useEffect(() => {
    ...
    if (savedResponses) dispatch(setResponses(JSON.parse(savedResponses)));
  ...
  const handleResponseChange = (index, answer) => {
    const newResponses = { ...quizState.responses, [index]: answer };
